...
export class VentasListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Mostrar notificación de mejoras PDF (solo una vez)
    this.mostrarNotificacionMejorasPdf();
  }

  private mostrarNotificacionMejorasPdf(): void {
    // Verificar si ya se mostró la notificación
    const yaVisto = localStorage.getItem('pdf_sunat_mejoras_visto');
    if (yaVisto) return;

    // Esperar un poco para que cargue la página
    setTimeout(() => {
      Swal.fire({
        title: '🎉 ¡Nuevo Sistema PDF SUNAT!',
        html: `
          <div class="text-start">
            <div class="alert alert-success mb-3">
              <h6 class="mb-2">✨ PDFs Mejorados con TODOS los Parámetros SUNAT</h6>
              <p class="mb-0">Ahora los PDFs incluyen todos los elementos requeridos por SUNAT para facturación electrónica.</p>
            </div>
            
            <h6 class="mb-2">📋 Nuevas características:</h6>
            <div class="row text-sm mb-3">
              <div class="col-6">
                🏢 Datos empresa completos<br>
                📄 Tipo específico de comprobante<br>
                🛍️ Detalle completo productos<br>
                ⚖️ Información legal SUNAT
              </div>
              <div class="col-6">
            ...
            <div class="alert alert-info">
              <h6 class="mb-2">🔧 Sistema Robusto:</h6>
              <p class="mb-1">• 3 niveles de plantillas con fallback garantizado</p>
              <p class="mb-1">• Múltiples motores PDF (DomPDF → HTML2PDF → HTML)</p>
              <p class="mb-0">• Logging completo y validación automática</p>
            </div>
            
            <div class="alert alert-warning">
              <h6 class="mb-2">🎯 Cómo usar:</h6>
              <p class="mb-1">1. <strong>Generar PDF:</strong> Use "🎯 Generar PDF SUNAT" en el menú</p>
              <p class="mb-1">2. <strong>Descargar:</strong> Use "📄 Descargar PDF" para obtener el archivo</p>
              <p class="mb-0">3. <strong>Regenerar:</strong> Use "🔄 Regenerar PDF" si necesita actualizar</p>
            </div>
            
            <p class="text-muted small mb-0">
              <strong>Nota:</strong> Los PDFs existentes seguirán funcionando. Las nuevas mejoras se aplicarán a los PDFs generados desde ahora.
            </p>
          </div>
        `,
        icon: 'info',
