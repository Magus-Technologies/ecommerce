...
>
  ...
  <nav class="sidebar-nav p-16">
    <ul class="list-style-none p-0 m-0">
      ...
      <li class="mb-8">
        <a
          routerLink="/dashboard/almacen"
          routerLinkActive="active"
          class="nav-link flex-align gap-12 px-16 py-12 text-white text-decoration-none rounded-8 transition-2 hover-bg-main-500"
        >
          <i class="ph ph-package text-xl flex-shrink-0"></i>
          <span *ngIf="!isCollapsed" class="fw-medium">Almacen</span>
        </a>
      </li>

      <!-- ✅ NUEVO: Ofertas y Promociones -->
      <li *ngIf="puedeVerOfertas" class="mb-8">
        <a
          routerLink="/dashboard/ofertas"
          routerLinkActive="active"
          class="nav-link flex-align gap-12 px-16 py-12 text-white text-decoration-none rounded-8 transition-2 hover-bg-main-500"
        >
          <i class="ph ph-tag text-xl flex-shrink-0"></i>
          <span *ngIf="!isCollapsed" class="fw-medium">Ofertas</span>
        </a>
      </li>

      <!-- ✅ NUEVO: Cupones -->
      <li *ngIf="puedeVerCupones" class="mb-8">
        <a
          routerLink="/dashboard/cupones"
          routerLinkActive="active"
          class="nav-link flex-align gap-12 px-16 py-12 text-white text-decoration-none rounded-8 transition-2 hover-bg-main-500"
        >
          <i class="ph ph-ticket text-xl flex-shrink-0"></i>
          <span *ngIf="!isCollapsed" class="fw-medium">Cupones</span>
        </a>
      </li>
      ...
      <li class="mb-8">
        <a
          *ngIf="puedeVerBanners"
          routerLink="/dashboard/banners"
          routerLinkActive="active"
          class="nav-link flex-align gap-12 px-16 py-12 text-white text-decoration-none rounded-8 transition-2 hover-bg-main-500"
        >
          <i class="ph ph-image text-xl flex-shrink-0"></i>
          <span *ngIf="!isCollapsed" class="fw-medium">Banners</span>
        </a>
      </li>
      <!-- banners promocional -->
      <li class="mb-8">
        <a
          *ngIf="puedeVerBanners_promocionales"
          routerLink="/dashboard/banners-promocionales"
          routerLinkActive="active"
          class="nav-link flex-align gap-12 px-16 py-12 text-white text-decoration-none rounded-8 transition-2 hover-bg-main-500"
        >
          <i class="ph ph-image text-xl flex-shrink-0"></i>
          <span *ngIf="!isCollapsed" class="fw-medium"
            >Banners Promocionales</span
          >
        </a>
      </li>

      <!-- Clientes -->
      <li *ngIf="puedeVerClientes" class="mb-8">
        <a
      ...
      <li *ngIf="puedeVerMotorizados" class="mb-8">
        <a
          routerLink="/dashboard/motorizados"
          routerLinkActive="active"
          class="nav-link flex-align gap-12 px-16 py-12 text-white text-decoration-none rounded-8 transition-2 hover-bg-main-500"
        >
          <i class="ph ph-motorcycle text-xl flex-shrink-0"></i>
          <span *ngIf="!isCollapsed" class="fw-medium">Motorizados</span>
        </a>
      </li>

      <!-- Usuarios (solo con permiso usuarios.ver) -->
      <li *ngIf="puedeVerUsuarios" class="mb-8">
        <a
          routerLink="/dashboard/usuarios"
          routerLinkActive="active"
          class="nav-link flex-align gap-12 px-16 py-12 text-white text-decoration-none rounded-8 transition-2 hover-bg-main-500"
        >
          <i class="ph ph-user-gear text-xl flex-shrink-0"></i>
          <span *ngIf="!isCollapsed" class="fw-medium">Usuarios</span>
        </a>
      </li>
